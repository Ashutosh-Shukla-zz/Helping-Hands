...
{
	private static final String USERNAME = "helping.hands.5100@gmail.com"; // change accordingly
	private static final String PASSWORD = "Password@123"; // change accordingly
	private static final String DEFAULT_FROM = "Helping Hands <helping.hands.5100@gmail.com>";
	...
	private final List mAttachments = new ArrayList();
	...
	public static EmailUtility subject(String subject) throws MessagingException
	{
	...
	public EmailUtility from(String from) throws AddressException, MessagingException
	{
		msg.setFrom(new InternetAddress(from));
		return this;
	}

	public EmailUtility replyTo(String replyTo) throws AddressException, MessagingException
	{
		msg.setReplyTo(InternetAddress.parse(replyTo.replaceAll(";", ",")));
		return this;
	}

	public EmailUtility to(String to) throws AddressException, MessagingException
	{
		msg.addRecipients(Message.RecipientType.TO, InternetAddress.parse(to.replaceAll(";", ",")));
		return this;
	}

	public EmailUtility cc(String cc) throws AddressException, MessagingException
	{
		msg.addRecipients(Message.RecipientType.CC, InternetAddress.parse(cc.replaceAll(";", ",")));
		return this;
	}

	public EmailUtility bcc(String bcc) throws AddressException, MessagingException
	{
		msg.addRecipients(Message.RecipientType.BCC, InternetAddress.parse(bcc.replaceAll(";", ",")));
		return this;
	}

	public EmailUtility text(String text) throws MessagingException
	{
		mText = text;
		return this;
	}

	public EmailUtility html(String html) throws MessagingException
	{
		mHtml = html;
		return this;
	}

	public EmailUtility attach(String filename, String mimeType, byte[] data) throws MessagingException
	{
	...
	public void send() throws MessagingException
	{
		...
		if (usingAlternative && hasAttachments)
		{
            ...
            for (Iterator it = mAttachments.iterator(); it.hasNext();) {

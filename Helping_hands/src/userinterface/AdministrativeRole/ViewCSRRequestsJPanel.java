 ...
 * @author shukl
 */
public class ViewCSRRequestsJPanel extends javax.swing.JPanel {
    ...
    public ViewCSRRequestsJPanel(JPanel userProcessContainer, Enterprise enterprise, EcoSystem system) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.system = system;
        this.enterprise = enterprise;
        populateRequestTable();
        populateFundRaiserTable();
    }
    ...
    private void initComponents() {
        ...
        giveMoneyButton = new javax.swing.JPanel();
        jLabel28 = new javax.swing.JLabel();
        jLabel29 = new javax.swing.JLabel();
        backJButton2 = new javax.swing.JPanel();
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request", "Enterprise Name", "Description", "Number Of Volunteers Required", "Number of Volunteer got", "Money Offered", "Project Date", "Status"
            }
        ) {
        ...
        jLabel23.setBackground(new java.awt.Color(22, 16, 16));
        jLabel23.setFont(new java.awt.Font("Serif", 0, 24)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(22, 16, 16));
        jLabel23.setText("My Csr Requests");
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 110, 1470, 190));
        ...
        FundTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request", "Enterprise Name", "Description", "Money needed", "Project Date", "Status"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jScrollPane2.setViewportView(FundTable);

        giveMoneyButton.setBackground(new java.awt.Color(0, 0, 0));
        giveMoneyButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        giveMoneyButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                giveMoneyButtonMouseClicked(evt);
            }
        });

        jLabel28.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel28.setForeground(new java.awt.Color(255, 255, 255));
        jLabel28.setText("Give Money");

        javax.swing.GroupLayout giveMoneyButtonLayout = new javax.swing.GroupLayout(giveMoneyButton);
        giveMoneyButton.setLayout(giveMoneyButtonLayout);
        giveMoneyButtonLayout.setHorizontalGroup(
            giveMoneyButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, giveMoneyButtonLayout.createSequentialGroup()
                .addContainerGap(22, Short.MAX_VALUE)
                .addComponent(jLabel28)
                .addGap(20, 20, 20))
        );
        giveMoneyButtonLayout.setVerticalGroup(
            giveMoneyButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, giveMoneyButtonLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel28)
        ...
        jLabel29.setBackground(new java.awt.Color(22, 16, 16));
        jLabel29.setFont(new java.awt.Font("Serif", 0, 24)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(22, 16, 16));
        jLabel29.setText("Fund Raiser Requests");

        backJButton2.setBackground(new java.awt.Color(0, 0, 0));
        backJButton2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        backJButton2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                backJButton2MouseClicked(evt);
            }
        });
        ...
        javax.swing.GroupLayout backJButton2Layout = new javax.swing.GroupLayout(backJButton2);
        backJButton2.setLayout(backJButton2Layout);
        backJButton2Layout.setHorizontalGroup(
            backJButton2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(backJButton2Layout.createSequentialGroup()
                .addGap(32, 32, 32)
                .addComponent(jLabel33)
                .addContainerGap(42, Short.MAX_VALUE))
        );
        backJButton2Layout.setVerticalGroup(
            backJButton2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(backJButton2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel33)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 1450, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(backJButton2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(51, 51, 51)
                        .addComponent(giveMoneyButton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(jLabel29, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 420, 1470, 290));
        ...
        raiseCSRRequestButton.add(jLabel47, new org.netbeans.lib.awtextra.AbsoluteConstraints(104, 0, -1, 38));
        ...
        viewRequestsButton.setBackground(new java.awt.Color(204, 204, 204));
        ...
        logoutJButton.add(jLabel49, new org.netbeans.lib.awtextra.AbsoluteConstraints(73, 23, 39, -1));

        jLabel51.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lock-unlock-1.png"))); // NOI18N
        logoutJButton.add(jLabel51, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 0, 40, 30));
        ...
        jLabel52.setIcon(new javax.swing.ImageIcon(getClass().getResource("/email-outbox.png"))); // NOI18N
        viewResourceRequestsButton.add(jLabel52, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 40, 30));
    ...
    private void giveMoneyButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_giveMoneyButtonMouseClicked
        int selectedRow = FundTable.getSelectedRow();
        ...
        FundRaisingActivityWorkRequest request = (FundRaisingActivityWorkRequest) FundTable.getValueAt(selectedRow, 0);
        if (request.getStatus().equalsIgnoreCase("Completed")) {
            ...
            if (enterprise.getResourcesOffered().keySet().contains("Money")) {
                test = Boolean.TRUE;
            }
            if (test) {
                FunRaiserDetailAddMoney viewRequestDetailsJPanel = new FunRaiserDetailAddMoney(userProcessContainer, request, enterprise, system);
    ...
    }//GEN-LAST:event_giveMoneyButtonMouseClicked

    private void backJButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backJButton2MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_backJButton2MouseClicked
    ...
    private void populateFundRaiserTable() {
        DefaultTableModel model = (DefaultTableModel) FundTable.getModel();

        model.setRowCount(0);

        for (Network network : system.getNetworkList()) {
            for (WorkRequest request : network.getWorkQueue().getWorkRequestList()) {
                if (request instanceof FundRaisingActivityWorkRequest) {
                    FundRaisingActivityWorkRequest res = (FundRaisingActivityWorkRequest) request;
                    Object[] row = new Object[6];
                    row[0] = res;
                    row[1] = res.getSender().getName();
                    row[2] = res.getMessage();
                    row[3] = res.getMoneyNeeded();
                    row[4] = res.getRequestDate();
                    row[5] = res.getStatus();
        ...
        for (Network network : system.getNetworkList()) {
            ...
            for (WorkRequest request : network.getWorkQueue().getWorkRequestList()) {
                if (request instanceof CSRActivityWorkRequest) {
                    CSRActivityWorkRequest res = (CSRActivityWorkRequest) request;
                    if (res.getEnterpriseName().equals(enterprise.getName())) {
                        Object[] row = new Object[8];
                        row[0] = res;
                        row[1] = res.getEnterpriseName();
                        row[2] = res.getDescription();
                        row[3] = res.getNumberOfVolunteersRequired();
                        row[4] = res.getNumberOfVolunteersAccepted();
                        row[5] = res.getMoneyOffered();
                        row[6] = res.getProjectDate();
                        row[7] = res.getStatus();
    ...
    private javax.swing.JPanel backJButton2;
    private javax.swing.JPanel buttonDashboard;
    private javax.swing.JPanel giveMoneyButton;

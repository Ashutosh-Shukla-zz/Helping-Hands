 ...
 * @author arpit
 */
public class CsrRequestReport extends javax.swing.JPanel {
private JPanel userProcessContainer;
  private EcoSystem system;
    private Enterprise enterprise;

    /**
     * Creates new form CsrRequestReport
     */
    public CsrRequestReport(JPanel userProcessContainer) {
        initComponents();
    ...
    {
    DefaultTableModel model = (DefaultTableModel) csrTable.getModel();
        model.setRowCount(0);
...
//        }
    ...
    private void initComponents() {
        ...
        csrTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 210, 843, 185));
        ...
        jLabel9.setText("CSR REQUEST REPORTS");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 120, 500, 70));
        ...
        add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 10, 500, 70));
        ...
        add(exportToexcel, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 450, 210, 50));
        ...
        add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 450, -1, 50));
...
Date date = new Date();
    ...
    SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT);
        export.exportTable(csrTable,new File(path+"ExportCSR"+sdf.format(date)+".csv"));

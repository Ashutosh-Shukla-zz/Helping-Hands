 ...
 * @author shukl
 */
public class RaiseCSRActivityJPanel extends javax.swing.JPanel {
    ...
    public RaiseCSRActivityJPanel(JPanel userProcessContainer, Enterprise enterprise, EcoSystem system) {
        initComponents();
        this.system = system;
    ...
    private void initComponents() {
        ...
        numberOfVolunteersTextField = new javax.swing.JTextField();
        ...
        jLabel17.setText("RAISE A NEW CSR REQUEST");
        ...
        jLabel24.setText("NUMBER OF VOLUNTEERS");
        jPanel1.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 320, -1, -1));

        jLabel25.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(255, 255, 255));
        jLabel25.setText("MONEY OFFEREED FOR THE PROJECT");
        ...
        numberOfVolunteersTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numberOfVolunteersTextFieldjTextField7ActionPerformed(evt);
            }
        });
        jPanel1.add(numberOfVolunteersTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 310, 170, -1));
        ...
        jLabel2.setText("RAISE A REQUEST");
        ...
        jPanel1.add(raiseRequestButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 490, -1, 50));
        ...
        jLabel9.setText("RAISE CSR ACTIVITY");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 10, 250, 70));
        ...
        jPanel4.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 13, 170, 70));
        ...
        raiseCSRRequestButton.setBackground(new java.awt.Color(204, 204, 204));
        ...
        ngoFunctionLabel.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel4.setText("View open request");
        viewRequestsButton.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));
        ...
        jLabel48.setText("Manage Reports");
        manageReport.add(jLabel48, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));
        ...
        logoutJButton.add(jLabel49, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 199, -1));
    ...
    private void numberOfVolunteersTextFieldjTextField7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numberOfVolunteersTextFieldjTextField7ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_numberOfVolunteersTextFieldjTextField7ActionPerformed
    ...
    private void raiseRequestButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_raiseRequestButtonMouseClicked
        CSRActivityWorkRequest activityWorkRequest = new CSRActivityWorkRequest();
        if (descriptionTextField.getText().equals("") || numberOfVolunteersTextField.getText().equals("") || moneyTextField.getText().equals("") || projectDateTextField.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Fields cannot be blank");
            return;
        } else {   //ResourcesWorkRequest workRequest = new ResourcesWorkRequest();
            activityWorkRequest.setRequsetId(Integer.parseInt(requestIdTextField.getText()));
            activityWorkRequest.setDescription(descriptionTextField.getText());
            activityWorkRequest.setNumberOfVolunteersRequired(Integer.parseInt(numberOfVolunteersTextField.getText()));
            activityWorkRequest.setMoneyOffered(Long.parseLong(moneyTextField.getText()));
            activityWorkRequest.setEnterpriseName(enterprise.getName());
            activityWorkRequest.setProjectDate(UtitlityMethods.getDateFromString(projectDateTextField.getText()));
            activityWorkRequest.setStatus("Pending");
            activityWorkRequest.setEnterpriseName(enterprise.getName());
            activityWorkRequest.setMessage("Csr Request");
            ...
            for (Network network : system.getNetworkList()) {
                ...
                //vorg.getWorkQueue().getWorkRequestList().add();
                //network.getWorkQueue().getWorkRequestList()
            }

            JOptionPane.showMessageDialog(null, "CSR Created Successfully");
            descriptionTextField.setText("");
            numberOfVolunteersTextField.setText("");
            moneyTextField.setText("");
            projectDateTextField.setText("");
        }
    }//GEN-LAST:event_raiseRequestButtonMouseClicked
    ...
    private javax.swing.JTextField numberOfVolunteersTextField;

 ...
 * @author shukl
 */
public class ViewDetailResourceJpanel extends javax.swing.JPanel {

    /**
     * Creates new form ViewDetailResourceJpanel
     */
    ...
    public ViewDetailResourceJpanel(JPanel userProcessContainer, Resource resource, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        expiryDateTextField1 = new javax.swing.JTextField();
        ...
        jPanel1.add(foodCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 50, -1, -1));
        ...
        jPanel1.add(educationCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 50, -1, -1));
        ...
        jPanel1.add(moneyCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 80, -1, -1));
        ...
        jPanel1.add(numberOfEducationTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 130, 131, -1));
        ...
        jPanel1.add(numberOfTeachersTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 131, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("No of Teachers Offered");
        ...
        jLabel10.setText("No of Food packets Offered");
        ...
        jPanel1.add(numberOfFoodPacksTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 220, 131, -1));
        ...
        jPanel1.add(quantityOfMedicineTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, 131, -1));
        ...
        jPanel1.add(nameOfMedicineTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 131, 20));

        jLabel11.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Quantity of medicine offered");
        ...
        jLabel15.setText("Medicine Type");
        ...
        jPanel1.add(medicineTypeTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 340, 131, 20));

        jLabel12.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("No of doctors offered");
        ...
        jPanel1.add(numberOFDoctorsTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, 131, 20));
        ...
        jPanel1.add(moneyTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 420, 131, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Money Offered in USD ");
        ...
        expiryDateTextField.setBackground(new java.awt.Color(255, 255, 255));
        expiryDateTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                expiryDateTextFieldActionPerformed(evt);
            }
        });
        jPanel1.add(expiryDateTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 460, 131, -1));

        expiryDateTextField1.setEditable(false);
        expiryDateTextField1.setBackground(new java.awt.Color(255, 255, 255));
        expiryDateTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                expiryDateTextField1ActionPerformed(evt);
            }
        });
        jPanel1.add(expiryDateTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 500, 131, -1));

        jLabel16.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Created Date");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 500, -1, -1));

        jLabel17.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Name of medicine");
        ...
        jPanel1.add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 530, -1, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Resources Offered");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, -1, -1));

        jLabel1.setText("$");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 410, 30, 30));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 110, -1, 600));

        jLabel31.setBackground(new java.awt.Color(22, 16, 16));
        jLabel31.setFont(new java.awt.Font("Serif", 0, 24)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(22, 16, 16));
        jLabel31.setText("MANAGE RESOURCES");
        add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 10, 330, 70));
        ...
        jPanel3.add(jLabel58, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 13, -1, -1));

        jLabel59.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        jLabel59.setText("a corporate social responsiblity request");
        jPanel3.add(jLabel59, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, 320, -1));

        jLabel60.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        jLabel60.setText("Click on \"Raise CSR request\"  to raise ");
        jPanel3.add(jLabel60, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 320, 26));

        jLabel61.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        jLabel61.setText("Click on \"Manage user account\"  to view and");
        jPanel3.add(jLabel61, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 50, 340, 30));

        jLabel62.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        jLabel62.setText("  and update the user information.");
        jPanel3.add(jLabel62, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 80, 320, 20));
        jPanel3.add(jLabel63, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 130, -1, 100));

        jLabel64.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        jLabel64.setText("Click on \"Manage organization and employee\" ");
        jPanel3.add(jLabel64, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, 350, 26));
        ...
        jLabel65.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-coins-filled-50.png"))); // NOI18N
        jPanel3.add(jLabel65, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 60, 50));

        jLabel66.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-plus-filled-50.png"))); // NOI18N
        jPanel3.add(jLabel66, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 50, 60, 50));

        jLabel67.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-unicast-filled-50.png"))); // NOI18N
        jPanel3.add(jLabel67, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 150, 60, 50));

        jLabel68.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-user-groups-filled-50.png"))); // NOI18N
        jPanel3.add(jLabel68, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 60, 50));
        ...
        jPanel3.add(jLabel69, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 150, 60, 50));
        ...
        jLabel18.setText("Manage User Account");
        manageUserAccount.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(112, 22, -1, -1));
        manageUserAccount.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 0, -1, 90));
        ...
        jLabel22.setText("Manage Resource ");
        manageResourceButton.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, -1, -1));
        manageResourceButton.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 0, -1, 90));
        ...
        jLabel28.setText("Manage Organization and Employee");
        manageEmployeeButton.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, -1, -1));
        manageEmployeeButton.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 0, -1, 90));
        ...
        jLabel30.setText("Manage Reports");
        manageReport.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 10, -1, -1));
        ...
        jLabel54.setText("Logout");
        logoutJButton.add(jLabel54, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 199, -1));
        ...
        jLabel55.setText("View Resource requests");
        viewResourceRequestsButton.add(jLabel55, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, -1, -1));
    ...
    private void expiryDateTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_expiryDateTextField1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_expiryDateTextField1ActionPerformed
    ...
    public void populateDetails() {
        ...
        if (resource instanceof MoneyResource) {
            MoneyResource moneyResource = (MoneyResource) resource;
            moneyTextField.setText(String.valueOf(moneyResource.getAmount()));
            expiryDateTextField.setText(UtitlityMethods.getStringFromDate(moneyResource.getExpiryDate()));

        } else if (resource instanceof FoodResource) {
            FoodResource foodResource = (FoodResource) resource;
            numberOFDoctorsTextField.setText(String.valueOf(foodResource.getNumberOfFoodPackets()));
        } else if (resource instanceof HealthResource) {
            HealthResource healthResource = (HealthResource) resource;
            nameOfMedicineTextField.setText(healthResource.getMedicineName());
            medicineTypeTextField.setText(healthResource.getMedicineType());
            quantityOfMedicineTextField.setText(String.valueOf(healthResource.getNumberOfPackets()));
            numberOFDoctorsTextField.setText(String.valueOf(healthResource.getNumberOfDoctors()));
        } else if (resource instanceof EducationResource) {
            EducationResource educationResource = (EducationResource) resource;
            numberOfEducationTextField.setText(String.valueOf(educationResource.getNumberOfSupplyMaterial()));
            numberOfTeachersTextField.setText(String.valueOf(educationResource.getNumberOfTeachers()));
        }
    }
    ...
    private javax.swing.JTextField expiryDateTextField1;

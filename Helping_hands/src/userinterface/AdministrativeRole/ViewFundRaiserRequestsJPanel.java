 ...
 * @author shukl
 */
public class ViewFundRaiserRequestsJPanel extends javax.swing.JPanel {
    ...
    public ViewFundRaiserRequestsJPanel(JPanel userProcessContainer, Enterprise enterprise, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        ownedRequestCheckBox = new javax.swing.JCheckBox();
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request", "Enterprise Name", "Description", "Money needed", "Money got", "Project Date", "Status"
            }
        ) {
        ...
        jLabel1.setText("Owned Requests");

        ownedRequestCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ownedRequestCheckBoxActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(ownedRequestCheckBox))
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 260, 1470, 290));
    ...
    private void ownedRequestCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ownedRequestCheckBoxActionPerformed
        populateRequestTable();
    }//GEN-LAST:event_ownedRequestCheckBoxActionPerformed
        ...
        for (Network network : system.getNetworkList()) {
            for (WorkRequest request : network.getWorkQueue().getWorkRequestList()) {
                if (request instanceof FundRaisingActivityWorkRequest) {
                    ...
                    if (res.getSender().getUsername().equals(system.getCurrentUserAccount().getUsername())) {
                        Object[] row = new Object[7];
                        row[0] = res;
                        row[1] = res.getSender().getName();
                        row[2] = res.getMessage();
                        row[3] = res.getMoneyNeeded();
                        row[4] = res.getMoneyGot();
                        //row[5] = res.getMoneyOffered();
                        row[5] = UtitlityMethods.getStringFromDate(res.getRequestDate());
                        row[6] = res.getStatus();
    ...
    private javax.swing.JCheckBox ownedRequestCheckBox;
